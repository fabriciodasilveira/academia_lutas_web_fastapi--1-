...
from src.routes import alunos_fastapi, professores_fastapi, turmas_fastapi, eventos_fastapi, financeiro_fastapi, matriculas_fastapi, planos_fastapi, mensalidades_fastapi, produtos_fastapi, categorias_fastapi
...
# # Importação dos modelos para que o SQLAlchemy os reconheça
# from src.models import aluno, professor, turma, evento, financeiro, matricula, plano, mensalidade, produto

# # Importação dos routers
# from src.routes import alunos_fastapi, professores_fastapi, turmas_fastapi, eventos_fastapi, financeiro_fastapi, matriculas_fastapi, planos_fastapi, mensalidades_fastapi, produtos_fastapi
# from src.database import engine, Base
