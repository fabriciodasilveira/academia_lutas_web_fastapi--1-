...
from src.models import aluno, professor, turma, evento, financeiro, matricula, plano, mensalidade, produto, categoria, historico_matricula, inscricao, presenca, graduacao,conteudo
...
from src.routes import (alunos_fastapi, professores_fastapi, turmas_fastapi, eventos_fastapi, 
                        ...
                        dashboard_fastapi, inscricoes_fastapi,portal_aluno_fastapi,portal_professor_fastapi,conteudos_fastapi
)
